...
<pre class="src src-python"><span class="linenr">1: </span><span style="color: #00ffff;">import</span> urllib2 
<span class="linenr">2: </span><span style="color: #eedd82;">response</span> = urllib2.urlopen(<span style="color: #ffa07a;">'http://python.org/'</span>)
<span class="linenr">3: </span><span style="color: #eedd82;">html</span> = reponse.read()
</pre>
</div>
</div>
</div>
...
<span style="color: #eedd82;">req</span> =  urllib2.Request(<span style="color: #ffa07a;">'http://www.voidspace.org.uk'</span>)
<span style="color: #eedd82;">response</span> = urllib2.urlopen(req)
<span style="color: #eedd82;">the_page</span> = response.read()
</pre>
</div>
</div>
</div>
...
<pre class="src src-python"><span style="color: #00ffff;">import</span> urllib
<span style="color: #00ffff;">import</span> urllib2

<span style="color: #eedd82;">url</span> = <span style="color: #ffa07a;">'http://www/someserver.com/cgi-bin/register.cgi'</span>
<span style="color: #eedd82;">value</span> = {<span style="color: #ffa07a;">'name'</span> : <span style="color: #ffa07a;">'Led Chang'</span>
...
<span style="color: #eedd82;">data</span> = urllib.urlencode(values)
<span style="color: #eedd82;">req</span> = urllib2.Request(url, data)
<span style="color: #eedd82;">response</span> = urllib2.urlopen(req)
<span style="color: #eedd82;">the_page</span> = response.read()
</pre>
</div>
...
&gt;&gt;&gt; <span style="color: #00ffff;">print</span> url_values
<span style="color: #eedd82;">name</span>=Somebody+Here&amp;language=Python&amp;location=Northampton
...
<span style="color: #eedd82;">url</span> = <span style="color: #ffa07a;">'http://www.someserver.com/cgi-bin/register.cgi'</span>
<span style="color: #eedd82;">user_agent</span> = <span style="color: #ffa07a;">'Mozilla/4.0 (compatible; MSIE 5.5; Windows NT)'</span>
<span style="color: #eedd82;">values</span> = {<span style="color: #ffa07a;">'name'</span> : <span style="color: #ffa07a;">'Michael Foord'</span>,
<span style="color: #ffa07a;">'location'</span> : <span style="color: #ffa07a;">'Northampton'</span>,
<span style="color: #ffa07a;">'language'</span> : <span style="color: #ffa07a;">'Python'</span> }
<span style="color: #eedd82;">headers</span> = { <span style="color: #ffa07a;">'User-Agent'</span> : user_agent }

<span style="color: #eedd82;">data</span> = urllib.urlencode(values)
<span style="color: #eedd82;">req</span> = urllib2.Request(url, data, headers)
<span style="color: #eedd82;">response</span> = urllib2.urlopen(req)
<span style="color: #eedd82;">the_page</span> = response.read()
</pre>
</div>
...
<p class="date">Created: 2013-08-14 Wed 14:44</p>
